 ...
 */
define( 'TWITCHPRESS_BOILERPLATE_VERSION', '1.0.0' );
define( 'TWITCHPRESS_BOILERPLATE_MIN_PHP_VER', '5.6.0' );
define( 'TWITCHPRESS_BOILERPLATE_MIN_TP_VER', '1.6.1' );
define( 'TWITCHPRESS_BOILERPLATE_MAIN_FILE', __FILE__ );
define( 'TWITCHPRESS_BOILERPLATE_PLUGIN_URL', untrailingslashit( plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) ) );
define( 'TWITCHPRESS_BOILERPLATE_PLUGIN_PATH', untrailingslashit( plugin_dir_path( __FILE__ ) ) );
...
if ( ! class_exists( 'TwitchPress_Boilerplate' ) ) :
    ...
    class TwitchPress_Boilerplate {
        ...
        private function define_constants() {
            ...
            if ( ! defined( 'TWITCHPRESS_BOILERPLATE_ABSPATH' ) )  { define( 'TWITCHPRESS_BOILERPLATE_ABSPATH', __FILE__ ); }
            if ( ! defined( 'TWITCHPRESS_BOILERPLATE_BASENAME' ) ) { define( 'TWITCHPRESS_BOILERPLATE_BASENAME', plugin_basename( __FILE__ ) ); }
            if ( ! defined( 'TWITCHPRESS_BOILERPLATE_DIR_PATH' ) ) { define( 'TWITCHPRESS_BOILERPLATE_DIR_PATH', plugin_dir_path( __FILE__ ) ); }
...
if( !function_exists( 'TwitchPress_Boiler_Ext' ) ) {
    ...
    function TwitchPress_Boiler_Ext() {        
        return TwitchPress_Boilerplate::instance();
    }
...
register_activation_hook( __FILE__, array( 'TwitchPress_Boilerplate', 'install' ) );
register_deactivation_hook( __FILE__, array( 'TwitchPress_Boilerplate', 'deactivate' ) );