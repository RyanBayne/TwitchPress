...
function twitchpress_kraken_endpoints_feed() {
    $endpoints = array();

    // Get Multiple Feed Posts
    $endpoints[] = array(
        'name'     => __( 'Get Multiple Feed Posts', 'twitchpress' ),
        'desc'     => __( 'Gets posts from a specified channel feed.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts',
        'doc'      => ''
    );

    // Get Feed Post
    $endpoints[] = array(
        'name'     => __( 'Get Feed Post', 'twitchpress' ),
        'desc'     => __( 'Gets a specified post from a specified channel feed.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>',
        'doc'      => ''
    );

    // Create Feed Post
    $endpoints[] = array(
        'name'     => __( 'Create Feed Post', 'twitchpress' ),
        'desc'     => __( 'Creates a post in a specified channel feed. The content of the post is specified in the request body, with a required content parameter.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts',
        'doc'      => ''
    );
    ...
    // Delete Feed Post
    $endpoints[] = array(
        'name'     => __( 'Delete Feed Post', 'twitchpress' ),
        'desc'     => __( 'Deletes a specified post in a specified channel feed.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>',
        'doc'      => ''
    );
    ...
    $endpoints[] = array(
        'name'     => __( 'Create Reaction to a Feed Post', 'twitchpress' ),
        'desc'     => __( 'Creates a reaction to a specified post in a specified channel feed. The reaction is specified by an emote value, which is either an ID (for example, “25” is Kappa) or the string “endorse” (which corresponds to a default face emote).', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/reactions?emote_id=<emote value>',
        'doc'      => ''
    );

    // Delete Reaction to a Feed Post
    $endpoints[] = array(
        'name'     => __( 'Delete Reaction to a Feed Post', 'twitchpress' ),
        'desc'     => __( 'Deletes a specified reaction to a specified post in a specified channel feed. The reaction is specified by an emote ID (for example, “25” is Kappa) or the string “endorse” (which corresponds to a default face emote).', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/reactions?emote_id=<emote value>',
        'doc'      => ''
    );
    ...
    // Get Feed Comments
    $endpoints[] = array(
        'name'     => __( 'Get Feed Comments', 'twitchpress' ),
        'desc'     => __( 'Gets all comments on a specified post in a specified channel feed.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/comments',
        'doc'      => ''
    );

    // Create Feed Comment
    $endpoints[] = array(
        'name'     => __( 'Create Feed Comment', 'twitchpress' ),
        'desc'     => __( 'Creates a comment to a specified post in a specified channel feed. The comment content can be specified either as a query-string parameter or in the request body (in x-www-form-urlencoded format).', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/comments',
        'doc'      => ''
    );
    ...
    // Delete Feed Comment
    $endpoints[] = array(
        'name'     => __( 'Delete Feed Comment', 'twitchpress' ),
        'desc'     => __( 'Deletes a specified comment on a specified post in a specified channel feed.', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/comments/<comment ID>',
        'doc'      => ''
    );

    // Create Reaction to a Feed Comment
    $endpoints[] = array(
        'name'     => __( 'Create Reaction to a Feed Comment', 'twitchpress' ),
        'desc'     => __( 'Creates a reaction to a specified comment on a specified post in a specified channel feed. The reaction is specified by an emote value, which is either an ID (for example, “25” is Kappa) or the string “endorse” (which corresponds to a default face emote).', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/comments/<comment ID>/reactions?emote_id=<emote value>',
        'doc'      => ''
    );

    // Delete Reaction to a Feed Comment
    $endpoints[] = array(
        'name'     => __( 'Delete Reaction to a Feed Comment', 'twitchpress' ),
        'desc'     => __( 'Deletes a reaction to a specified comment on a specified post in a specified channel feed. The reaction is specified by an emote value, which is either an ID (for example, “25” is Kappa) or the string “endorse” (which corresponds to a default face emote).', 'twitchpress' ),
        'url'      => 'https://api.twitch.tv/kraken/feed/<channel ID>/posts/<post ID>/comments/<comment ID>/reactions?emote_id=<emote value>',
        'doc'      => ''
    );
