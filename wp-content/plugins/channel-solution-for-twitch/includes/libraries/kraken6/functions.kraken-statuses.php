...
function kraken_httpstatuses( $requested_status = null, $requested_meaning = 'short' ) {
    ...
    $httpstatus[102]['short'] = __( 'Processing (WebDAV; RFC 2518)', 'twitchpress' );
    ...
    $httpstatus[203]['short'] = __( 'Non-Authoritative Information (since HTTP/1.1)', 'twitchpress' );
    ...
    $httpstatus[206]['short'] = __( 'Partial Content (RFC 7233)', 'twitchpress' );
    ...
    $httpstatus[207]['short'] = __( 'Multi-Status (WebDAV; RFC 4918)', 'twitchpress' );
    ...
    $httpstatus[208]['short'] = __( 'Already Reported (WebDAV; RFC 5842)', 'twitchpress' );
    ...
    $httpstatus[226]['short'] = __( 'IM Used (RFC 3229)', 'twitchpress' );
    ...
    $httpstatus[303]['short'] = __( 'See Other (since HTTP/1.1)', 'twitchpress' );
    ...
    $httpstatus[304]['short'] = __( 'Not Modified (RFC 7232)', 'twitchpress' );
    ...
    $httpstatus[305]['short'] = __( 'Use Proxy (since HTTP/1.1)', 'twitchpress' );
    ...
    $httpstatus[307]['short'] = __( 'Temporary Redirect (since HTTP/1.1)', 'twitchpress' );
    ...
    $httpstatus[308]['short'] = __( 'Permanent Redirect (RFC 7538)', 'twitchpress' );
    ...
    $httpstatus[403]['wiki'] = __( "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource, or may need an account of some sort.", 'twitchpress' );
    
    $httpstatus[404]['short'] = __( 'Not Found', 'twitchpress' );
    $httpstatus[404]['wiki'] = __( "The requested resource could not be found but may be available in the future. Subsequent requests by the client are permissible.", 'twitchpress' );
    ...
    $httpstatus[407]['short'] = __( 'Proxy Authentication Required (RFC 7235)', 'twitchpress' );
    ...
    $httpstatus[412]['short'] = __( 'Precondition Failed (RFC 7232)', 'twitchpress' );
    ...
    $httpstatus[413]['short'] = __( 'Payload Too Large (RFC 7231)', 'twitchpress' );
    ...
    $httpstatus[414]['short'] = __( 'URI Too Long (RFC 7231)', 'twitchpress' );
    ...
    $httpstatus[416]['short'] = __( 'Range Not Satisfiable (RFC 7233)', 'twitchpress' );
    ...
    $httpstatus[418]['short'] = __( 'I\'m a teapot (RFC 2324)', 'twitchpress' );
    ...
    $httpstatus[421]['short'] = __( 'Misdirected Request (RFC 7540)', 'twitchpress' );
    ...
    $httpstatus[422]['short'] = __( 'Unprocessable Entity (WebDAV; RFC 4918)', 'twitchpress' );
    $httpstatus[422]['wiki'] = __( "The request was well-formed but was unable to be followed due to semantic errors.", 'twitchpress' );
    
    $httpstatus[423]['short'] = __( 'Locked (WebDAV; RFC 4918)', 'twitchpress' );
    $httpstatus[423]['wiki'] = __( "The resource that is being accessed is locked.", 'twitchpress' );
    
    $httpstatus[424]['short'] = __( 'Failed Dependency (WebDAV; RFC 4918)', 'twitchpress' );
    ...
    $httpstatus[428]['short'] = __( 'Precondition Required (RFC 6585)', 'twitchpress' );
    $httpstatus[428]['wiki'] = __( "The origin server requires the request to be conditional. Intended to prevent the 'lost update' problem, where a client GETs a resource's state, modifies it, and PUTs it back to the server, when meanwhile a third party has modified the state on the server, leading to a conflict.", 'twitchpress' );
    
    $httpstatus[429]['short'] = __( 'Too Many Requests (RFC 6585)', 'twitchpress' );
    $httpstatus[429]['wiki'] = __( "The user has sent too many requests in a given amount of time. Intended for use with rate-limiting schemes.", 'twitchpress' );
    
    $httpstatus[431]['short'] = __( 'Request Header Fields Too Large (RFC 6585)', 'twitchpress' );
    ...
    $httpstatus[451]['short'] = __( 'Unavailable For Legal Reasons (RFC 7725)', 'twitchpress' );
    ...
    $httpstatus[503]['wiki'] = __( "The server is currently unavailable (because it is overloaded or down for maintenance). Generally, this is a temporary state.", 'twitchpress' );
    ...
    $httpstatus[510]['short'] = __( 'Not Extended (RFC 2774)', 'twitchpress' );
    ...
    $httpstatus[420]['short'] = __( 'Enhance Your Calm (Twitter)', 'twitchpress' );
    $httpstatus[420]['wiki'] = __( "Returned by version 1 of the Twitter Search and Trends API when the client is being rate limited; versions 1.1 and later use the 429 Too Many Requests response code instead.", 'twitchpress' );
    
    $httpstatus[450]['short'] = __( 'Blocked by Windows Parental Controls (Microsoft)', 'twitchpress' );
    $httpstatus[450]['wiki'] = __( "The Microsoft extension code indicated when Windows Parental Controls are turned on and are blocking access to the requested webpage.", 'twitchpress' );
    ...
    $httpstatus[499]['short'] = __( 'Token Required (Esri)', 'twitchpress' );
    $httpstatus[499]['wiki'] = __( "Returned by ArcGIS for Server. Code 499 indicates that a token is required but was not submitted.", 'twitchpress' );
    ...
    $httpstatus[598]['short'] = __( '(Informal convention) Network read timeout error', 'twitchpress' );
