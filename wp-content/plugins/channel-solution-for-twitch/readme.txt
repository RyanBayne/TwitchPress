...
* DEV  - New option for removing all TwitchPress extensions during deletion of plugin (option key: twitchpress_remove_extensions)
...
* DEV  - uninstall.php has been simplified, procedure moved to class.twitchpress-admin-uninstall.php
